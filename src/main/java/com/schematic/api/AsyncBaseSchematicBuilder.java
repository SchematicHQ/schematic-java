...
import com.schematic.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncBaseSchematicBuilder {
     ...
     */
    public AsyncBaseSchematicBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncBaseSchematicBuilder addHeader(String name, String value) {
    ...
    public AsyncBaseSchematic build() {
        ...
        return new AsyncBaseSchematic(buildClientOptions());
    }
}
