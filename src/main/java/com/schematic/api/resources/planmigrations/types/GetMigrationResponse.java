...
@JsonDeserialize(builder = GetMigrationResponse.Builder.class)
public final class GetMigrationResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetMigrationResponse && equalTo((GetMigrationResponse) other);
    }
    ...
    private boolean equalTo(GetMigrationResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(GetMigrationResponse other);
    }

    public interface _FinalStage {
        GetMigrationResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetMigrationResponse other) {
            data(other.getData());
        ...
        public GetMigrationResponse build() {
            return new GetMigrationResponse(data, params, additionalProperties);
        }
