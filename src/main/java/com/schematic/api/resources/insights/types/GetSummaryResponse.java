...
import com.schematic.api.types.InsightsSummaryResponseData;
...
public final class GetSummaryResponse {
    private final InsightsSummaryResponseData data;
    ...
    private GetSummaryResponse(
            InsightsSummaryResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    @JsonProperty("data")
    public InsightsSummaryResponseData getData() {
        return data;
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull InsightsSummaryResponseData data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private InsightsSummaryResponseData data;
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull InsightsSummaryResponseData data) {
        ...
        public GetSummaryResponse build() {
            return new GetSummaryResponse(data, params, additionalProperties);
        }
