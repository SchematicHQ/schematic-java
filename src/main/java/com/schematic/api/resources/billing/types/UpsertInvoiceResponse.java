...
@JsonDeserialize(builder = UpsertInvoiceResponse.Builder.class)
public final class UpsertInvoiceResponse {
    private final InvoiceResponseData data;

    private final Map<String, JsonNode> params;

    private final Map<String, Object> additionalProperties;

    private UpsertInvoiceResponse(
            InvoiceResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertInvoiceResponse && equalTo((UpsertInvoiceResponse) other);
    }
    ...
    private boolean equalTo(UpsertInvoiceResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull InvoiceResponseData data);

        Builder from(UpsertInvoiceResponse other);
    }

    public interface _FinalStage {
        UpsertInvoiceResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpsertInvoiceResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull InvoiceResponseData data) {
        ...
        @java.lang.Override
        public UpsertInvoiceResponse build() {
            return new UpsertInvoiceResponse(data, params, additionalProperties);
        }
    }
}
