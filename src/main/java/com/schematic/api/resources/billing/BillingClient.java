...
public class BillingClient {
    ...
    public DeletePaymentMethodByExternalIdResponse deletePaymentMethodByExternalId(String billingId) {
        return this.rawClient.deletePaymentMethodByExternalId(billingId).body();
    }

    public DeletePaymentMethodByExternalIdResponse deletePaymentMethodByExternalId(
