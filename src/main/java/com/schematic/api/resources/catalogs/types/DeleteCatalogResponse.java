...
public final class DeleteCatalogResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteCatalogResponse && equalTo((DeleteCatalogResponse) other);
    }
    ...
    private boolean equalTo(DeleteCatalogResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteCatalogResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteCatalogResponse other) {
            data(other.getData());
        ...
        public DeleteCatalogResponse build() {
            return new DeleteCatalogResponse(data, params, additionalProperties);
        }
