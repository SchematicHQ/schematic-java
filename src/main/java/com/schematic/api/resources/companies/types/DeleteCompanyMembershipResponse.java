...
@JsonDeserialize(builder = DeleteCompanyMembershipResponse.Builder.class)
public final class DeleteCompanyMembershipResponse {
    ...
    private DeleteCompanyMembershipResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteCompanyMembershipResponse && equalTo((DeleteCompanyMembershipResponse) other);
    }
    ...
    private boolean equalTo(DeleteCompanyMembershipResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteCompanyMembershipResponse other);
    }

    public interface _FinalStage {
        DeleteCompanyMembershipResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteCompanyMembershipResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public DeleteCompanyMembershipResponse build() {
            return new DeleteCompanyMembershipResponse(data, params, additionalProperties);
        }
    }
}
