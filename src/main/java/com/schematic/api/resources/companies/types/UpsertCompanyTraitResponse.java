...
@JsonDeserialize(builder = UpsertCompanyTraitResponse.Builder.class)
public final class UpsertCompanyTraitResponse {
    ...
    private UpsertCompanyTraitResponse(
            CompanyDetailResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertCompanyTraitResponse && equalTo((UpsertCompanyTraitResponse) other);
    }
    ...
    private boolean equalTo(UpsertCompanyTraitResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(CompanyDetailResponseData data);

        Builder from(UpsertCompanyTraitResponse other);
    }

    public interface _FinalStage {
        UpsertCompanyTraitResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpsertCompanyTraitResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(CompanyDetailResponseData data) {
            this.data = data;
            return this;
        }
        ...
        @java.lang.Override
        public UpsertCompanyTraitResponse build() {
            return new UpsertCompanyTraitResponse(data, params, additionalProperties);
        }
    }
}
