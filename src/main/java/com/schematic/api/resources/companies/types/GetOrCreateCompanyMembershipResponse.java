...
public final class GetOrCreateCompanyMembershipResponse {
    private final CompanyMembershipDetailResponseData data;

    private final Map<String, JsonNode> params;

    private final Map<String, Object> additionalProperties;

    private GetOrCreateCompanyMembershipResponse(
            CompanyMembershipDetailResponseData data,
    ...
    @JsonProperty("data")
    public CompanyMembershipDetailResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetOrCreateCompanyMembershipResponse
                && equalTo((GetOrCreateCompanyMembershipResponse) other);
    }
    ...
    private boolean equalTo(GetOrCreateCompanyMembershipResponse other) {
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private CompanyMembershipDetailResponseData data;
        ...
        @java.lang.Override
        public Builder from(GetOrCreateCompanyMembershipResponse other) {
            data(other.getData());
