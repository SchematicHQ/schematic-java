...
@JsonDeserialize(builder = LookupUserRequest.Builder.class)
public final class LookupUserRequest {
    private final Map<String, JsonNode> keys;

    private final Map<String, Object> additionalProperties;

    private LookupUserRequest(Map<String, JsonNode> keys, Map<String, Object> additionalProperties) {
        this.keys = keys;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LookupUserRequest && equalTo((LookupUserRequest) other);
    }
    ...
    private boolean equalTo(LookupUserRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(LookupUserRequest other) {
            keys(other.getKeys());
            return this;
        }
        ...
        public LookupUserRequest build() {
            return new LookupUserRequest(keys, additionalProperties);
        }
    }
}
