...
@JsonDeserialize(builder = GetCompanyResponse.Builder.class)
public final class GetCompanyResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetCompanyResponse && equalTo((GetCompanyResponse) other);
    }
    ...
    private boolean equalTo(GetCompanyResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(GetCompanyResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetCompanyResponse other) {
            data(other.getData());
        ...
        public GetCompanyResponse build() {
            return new GetCompanyResponse(data, params, additionalProperties);
        }
    }
}
