...
@JsonDeserialize(builder = UpdateEntityTraitDefinitionResponse.Builder.class)
public final class UpdateEntityTraitDefinitionResponse {
    private final EntityTraitDefinitionResponseData data;

    private final Map<String, JsonNode> params;

    private final Map<String, Object> additionalProperties;

    private UpdateEntityTraitDefinitionResponse(
            EntityTraitDefinitionResponseData data,
    ...
    @JsonProperty("data")
    public EntityTraitDefinitionResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateEntityTraitDefinitionResponse
                && equalTo((UpdateEntityTraitDefinitionResponse) other);
    }
    ...
    private boolean equalTo(UpdateEntityTraitDefinitionResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(UpdateEntityTraitDefinitionResponse other);
    }

    public interface _FinalStage {
        UpdateEntityTraitDefinitionResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private EntityTraitDefinitionResponseData data;
        ...
        @java.lang.Override
        public Builder from(UpdateEntityTraitDefinitionResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public UpdateEntityTraitDefinitionResponse build() {
            return new UpdateEntityTraitDefinitionResponse(data, params, additionalProperties);
        }
    }
}
