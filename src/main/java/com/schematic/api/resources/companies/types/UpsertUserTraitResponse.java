...
@JsonDeserialize(builder = UpsertUserTraitResponse.Builder.class)
public final class UpsertUserTraitResponse {
    ...
    private UpsertUserTraitResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertUserTraitResponse && equalTo((UpsertUserTraitResponse) other);
    }
    ...
    private boolean equalTo(UpsertUserTraitResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull UserDetailResponseData data);

        Builder from(UpsertUserTraitResponse other);
    }

    public interface _FinalStage {
        UpsertUserTraitResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpsertUserTraitResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull UserDetailResponseData data) {
        ...
        @java.lang.Override
        public UpsertUserTraitResponse build() {
            return new UpsertUserTraitResponse(data, params, additionalProperties);
        }
    }
}
