...
public class RawCompaniesClient {
    ...
    public BaseSchematicHttpResponse<GetCompanyBillingEntityResponse> getCompanyBillingEntity(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCompanyBillingEntityResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, GetBillingEntityChildSubscriptionsResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
    ...
    public BaseSchematicHttpResponse<DeleteEntityTraitDefinitionResponse> deleteEntityTraitDefinition(
            String entityTraitDefinitionId) {
    ...
    public BaseSchematicHttpResponse<GetEntityTraitDefinitionUsageResponse> getEntityTraitDefinitionUsage(
            String entityTraitDefinitionId) {
    ...
    public BaseSchematicHttpResponse<CountEntityTraitsResponse> countEntityTraits() {
        return countEntityTraits(CountEntityTraitsRequest.builder().build());
    }

    public BaseSchematicHttpResponse<CountEntityTraitsResponse> countEntityTraits(RequestOptions requestOptions) {
        return countEntityTraits(CountEntityTraitsRequest.builder().build(), requestOptions);
    }

    public BaseSchematicHttpResponse<CountEntityTraitsResponse> countEntityTraits(CountEntityTraitsRequest request) {
