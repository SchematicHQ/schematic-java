...
public final class CountPlanTraitsRequest {
    ...
    private final Optional<String> traitIds;
    ...
    public Optional<String> getTraitIds() {
        return traitIds;
    }
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.ids, this.planId, this.traitId, this.traitIds, this.limit, this.offset);
    }
    ...
    public static final class Builder {
        ...
        private Optional<String> traitIds = Optional.empty();
        ...
        public Builder traitIds(Optional<String> traitIds) {
            this.traitIds = traitIds;
            return this;
        }
        ...
        public CountPlanTraitsRequest build() {
            return new CountPlanTraitsRequest(ids, planId, traitId, traitIds, limit, offset, additionalProperties);
        }
    }
}
