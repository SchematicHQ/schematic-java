...
public final class DeleteCompanyByKeysResponse {
    ...
    private DeleteCompanyByKeysResponse(
            CompanyResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteCompanyByKeysResponse && equalTo((DeleteCompanyByKeysResponse) other);
    }
    ...
    private boolean equalTo(DeleteCompanyByKeysResponse other) {
    ...
    public interface _FinalStage {
        DeleteCompanyByKeysResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteCompanyByKeysResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public DeleteCompanyByKeysResponse build() {
            return new DeleteCompanyByKeysResponse(data, params, additionalProperties);
        }
    }
}
