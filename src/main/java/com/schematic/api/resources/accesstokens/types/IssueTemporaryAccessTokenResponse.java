 ...
 */
package com.schematic.api.resources.accesstokens.types;
...
import com.schematic.api.types.IssueTemporaryAccessTokenResponseData;
...
public final class IssueTemporaryAccessTokenResponse {
    ...
    private IssueTemporaryAccessTokenResponse(
            IssueTemporaryAccessTokenResponseData data,
    ...
    @JsonProperty("data")
    public IssueTemporaryAccessTokenResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IssueTemporaryAccessTokenResponse && equalTo((IssueTemporaryAccessTokenResponse) other);
    }
    ...
    private boolean equalTo(IssueTemporaryAccessTokenResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull IssueTemporaryAccessTokenResponseData data);

        Builder from(IssueTemporaryAccessTokenResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private IssueTemporaryAccessTokenResponseData data;
        ...
        @java.lang.Override
        public Builder from(IssueTemporaryAccessTokenResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull IssueTemporaryAccessTokenResponseData data) {
