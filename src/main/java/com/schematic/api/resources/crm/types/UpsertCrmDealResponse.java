...
public final class UpsertCrmDealResponse {
    ...
    private UpsertCrmDealResponse(
            CrmDealResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public interface DataStage {
        _FinalStage data(CrmDealResponseData data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(CrmDealResponseData data) {
            this.data = data;
            return this;
        }
