...
public class AsyncRawCrmClient {
    protected final ClientOptions clientOptions;

    public AsyncRawCrmClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<BaseSchematicHttpResponse<UpsertDealLineItemAssociationResponse>>
            upsertDealLineItemAssociation(CreateCrmDealLineItemAssociationRequestBody request) {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertDealLineItemAssociationResponse>>
        ...
        CompletableFuture<BaseSchematicHttpResponse<UpsertDealLineItemAssociationResponse>> future =
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertLineItemResponse>> upsertLineItem(
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertLineItemResponse>> upsertLineItem(
        ...
        CompletableFuture<BaseSchematicHttpResponse<UpsertLineItemResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BaseSchematicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), UpsertLineItemResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertCrmDealResponse>> upsertCrmDeal(
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertCrmDealResponse>> upsertCrmDeal(
        ...
        CompletableFuture<BaseSchematicHttpResponse<UpsertCrmDealResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<ListCrmProductsResponse>> listCrmProducts() {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<ListCrmProductsResponse>> listCrmProducts(
        ...
        CompletableFuture<BaseSchematicHttpResponse<ListCrmProductsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BaseSchematicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), ListCrmProductsResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertCrmProductResponse>> upsertCrmProduct(
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpsertCrmProductResponse>> upsertCrmProduct(
        ...
        CompletableFuture<BaseSchematicHttpResponse<UpsertCrmProductResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BaseSchematicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), UpsertCrmProductResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
