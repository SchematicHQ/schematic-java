...
@JsonDeserialize(builder = CreateComponentResponse.Builder.class)
public final class CreateComponentResponse {
    ...
    private CreateComponentResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateComponentResponse && equalTo((CreateComponentResponse) other);
    }
    ...
    private boolean equalTo(CreateComponentResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(CreateComponentResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateComponentResponse other) {
            data(other.getData());
        ...
        public CreateComponentResponse build() {
            return new CreateComponentResponse(data, params, additionalProperties);
        }
    }
}
