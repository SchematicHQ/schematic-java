...
@JsonDeserialize(builder = BindCatalogResponse.Builder.class)
public final class BindCatalogResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BindCatalogResponse && equalTo((BindCatalogResponse) other);
    }
    ...
    private boolean equalTo(BindCatalogResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull ComponentResponseData data);

        Builder from(BindCatalogResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BindCatalogResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull ComponentResponseData data) {
        ...
        @java.lang.Override
        public BindCatalogResponse build() {
            return new BindCatalogResponse(data, params, additionalProperties);
        }
