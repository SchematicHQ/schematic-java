...
public class CreditsClient {
    ...
    public ReleaseCreditLeaseResponse releaseCreditLease(String leaseId) {
        return this.rawClient.releaseCreditLease(leaseId).body();
    }

    public ReleaseCreditLeaseResponse releaseCreditLease(String leaseId, RequestOptions requestOptions) {
        return this.rawClient.releaseCreditLease(leaseId, requestOptions).body();
    }
    ...
    public ReleaseCreditReservationResponse releaseCreditReservation(String reservationId) {
        return this.rawClient.releaseCreditReservation(reservationId).body();
    }
