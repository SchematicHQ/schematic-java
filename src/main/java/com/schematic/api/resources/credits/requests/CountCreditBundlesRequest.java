...
@JsonDeserialize(builder = CountCreditBundlesRequest.Builder.class)
public final class CountCreditBundlesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CountCreditBundlesRequest && equalTo((CountCreditBundlesRequest) other);
    }
    ...
    private boolean equalTo(CountCreditBundlesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CountCreditBundlesRequest other) {
            ids(other.getIds());
        ...
        public CountCreditBundlesRequest build() {
            return new CountCreditBundlesRequest(
                    ids, creditId, status, bundleType, limit, offset, additionalProperties);
        }
    }
}
