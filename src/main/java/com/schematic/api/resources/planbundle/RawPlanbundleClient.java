...
public class RawPlanbundleClient {
    protected final ClientOptions clientOptions;

    public RawPlanbundleClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public BaseSchematicHttpResponse<CreateCustomPlanBundleResponse> createCustomPlanBundle(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateCustomPlanBundleResponse.class),
                        response);
            }
            try {
    ...
    public BaseSchematicHttpResponse<CreatePlanBundleResponse> createPlanBundle(CreatePlanBundleRequestBody request) {
        return createPlanBundle(request, null);
    }

    public BaseSchematicHttpResponse<CreatePlanBundleResponse> createPlanBundle(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreatePlanBundleResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
    ...
    public BaseSchematicHttpResponse<UpdatePlanBundleResponse> updatePlanBundle(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdatePlanBundleResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
