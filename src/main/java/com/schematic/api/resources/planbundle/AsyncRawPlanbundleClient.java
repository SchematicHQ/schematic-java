...
public class AsyncRawPlanbundleClient {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<CreatePlanBundleResponse>> createPlanBundle(
        ...
        CompletableFuture<BaseSchematicHttpResponse<CreatePlanBundleResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpdatePlanBundleResponse>> updatePlanBundle(
        ...
        CompletableFuture<BaseSchematicHttpResponse<UpdatePlanBundleResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
