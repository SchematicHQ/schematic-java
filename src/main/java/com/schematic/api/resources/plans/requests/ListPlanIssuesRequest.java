...
@JsonDeserialize(builder = ListPlanIssuesRequest.Builder.class)
public final class ListPlanIssuesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListPlanIssuesRequest && equalTo((ListPlanIssuesRequest) other);
    }
    ...
    public interface PlanIdStage {
        ...
        Builder from(ListPlanIssuesRequest other);
    }
