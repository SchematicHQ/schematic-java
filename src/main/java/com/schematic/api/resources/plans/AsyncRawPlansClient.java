...
public class AsyncRawPlansClient {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<GetAudienceResponse>> getAudience(String planAudienceId) {
        return getAudience(planAudienceId, null);
    }

    public CompletableFuture<BaseSchematicHttpResponse<GetAudienceResponse>> getAudience(
        ...
        CompletableFuture<BaseSchematicHttpResponse<GetAudienceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpdateAudienceResponse>> updateAudience(
    ...
    public CompletableFuture<BaseSchematicHttpResponse<UpdateAudienceResponse>> updateAudience(
        ...
        CompletableFuture<BaseSchematicHttpResponse<UpdateAudienceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BaseSchematicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), UpdateAudienceResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
    ...
    public CompletableFuture<BaseSchematicHttpResponse<DeleteAudienceResponse>> deleteAudience(String planAudienceId) {
        return deleteAudience(planAudienceId, null);
    }

    public CompletableFuture<BaseSchematicHttpResponse<DeleteAudienceResponse>> deleteAudience(
            String planAudienceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("plan-audiences")
        ...
        CompletableFuture<BaseSchematicHttpResponse<DeleteAudienceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new BaseSchematicHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), DeleteAudienceResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
