...
@JsonDeserialize(builder = DeletePlanResponse.Builder.class)
public final class DeletePlanResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeletePlanResponse && equalTo((DeletePlanResponse) other);
    }
    ...
    private boolean equalTo(DeletePlanResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeletePlanResponse other);
    }

    public interface _FinalStage {
        DeletePlanResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeletePlanResponse other) {
            data(other.getData());
        ...
        public DeletePlanResponse build() {
            return new DeletePlanResponse(data, params, additionalProperties);
        }
    }
}
