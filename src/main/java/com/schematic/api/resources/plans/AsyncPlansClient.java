...
public class AsyncPlansClient {
    ...
    public CompletableFuture<GetAudienceResponse> getAudience(String planAudienceId) {
        return this.rawClient.getAudience(planAudienceId).thenApply(response -> response.body());
    }

    public CompletableFuture<GetAudienceResponse> getAudience(String planAudienceId, RequestOptions requestOptions) {
        return this.rawClient.getAudience(planAudienceId, requestOptions).thenApply(response -> response.body());
    }

    public CompletableFuture<UpdateAudienceResponse> updateAudience(
            String planAudienceId, UpdateAudienceRequestBody request) {
        return this.rawClient.updateAudience(planAudienceId, request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<DeleteAudienceResponse> deleteAudience(String planAudienceId) {
        return this.rawClient.deleteAudience(planAudienceId).thenApply(response -> response.body());
    }

    public CompletableFuture<DeleteAudienceResponse> deleteAudience(
            String planAudienceId, RequestOptions requestOptions) {
        return this.rawClient.deleteAudience(planAudienceId, requestOptions).thenApply(response -> response.body());
    }
