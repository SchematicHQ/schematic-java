...
@JsonDeserialize(builder = UpdateAudienceResponse.Builder.class)
public final class UpdateAudienceResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateAudienceResponse && equalTo((UpdateAudienceResponse) other);
    }
    ...
    private boolean equalTo(UpdateAudienceResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull PlanAudienceDetailResponseData data);

        Builder from(UpdateAudienceResponse other);
    }

    public interface _FinalStage {
        UpdateAudienceResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateAudienceResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull PlanAudienceDetailResponseData data) {
        ...
        @java.lang.Override
        public UpdateAudienceResponse build() {
            return new UpdateAudienceResponse(data, params, additionalProperties);
        }
    }
}
