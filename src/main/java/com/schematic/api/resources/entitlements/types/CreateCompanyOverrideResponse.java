...
@JsonDeserialize(builder = CreateCompanyOverrideResponse.Builder.class)
public final class CreateCompanyOverrideResponse {
    ...
    private CreateCompanyOverrideResponse(
            CompanyOverrideResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    @JsonProperty("data")
    public CompanyOverrideResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateCompanyOverrideResponse && equalTo((CreateCompanyOverrideResponse) other);
    }
    ...
    private boolean equalTo(CreateCompanyOverrideResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(CreateCompanyOverrideResponse other);
    }

    public interface _FinalStage {
        CreateCompanyOverrideResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private CompanyOverrideResponseData data;
        ...
        @java.lang.Override
        public Builder from(CreateCompanyOverrideResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public CreateCompanyOverrideResponse build() {
            return new CreateCompanyOverrideResponse(data, params, additionalProperties);
        }
    }
}
