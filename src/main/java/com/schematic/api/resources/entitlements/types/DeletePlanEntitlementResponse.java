...
@JsonDeserialize(builder = DeletePlanEntitlementResponse.Builder.class)
public final class DeletePlanEntitlementResponse {
    ...
    private DeletePlanEntitlementResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeletePlanEntitlementResponse && equalTo((DeletePlanEntitlementResponse) other);
    }
    ...
    private boolean equalTo(DeletePlanEntitlementResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeletePlanEntitlementResponse other);
    }

    public interface _FinalStage {
        DeletePlanEntitlementResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeletePlanEntitlementResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public DeletePlanEntitlementResponse build() {
            return new DeletePlanEntitlementResponse(data, params, additionalProperties);
        }
    }
}
