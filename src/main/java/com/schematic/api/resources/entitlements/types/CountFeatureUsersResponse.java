...
public final class CountFeatureUsersResponse {
    private final CountResponse data;

    private final CountFeatureUsersParams params;

    private final Map<String, Object> additionalProperties;

    private CountFeatureUsersResponse(
            CountResponse data, CountFeatureUsersParams params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
     ...
     */
    @JsonProperty("params")
    public CountFeatureUsersParams getParams() {
        return params;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CountFeatureUsersResponse && equalTo((CountFeatureUsersResponse) other);
    }
    ...
    private boolean equalTo(CountFeatureUsersResponse other) {
    ...
    public interface _FinalStage {
        CountFeatureUsersResponse build();
    }
    ...
    public static final class Builder implements DataStage, ParamsStage, _FinalStage {
        ...
        private CountFeatureUsersParams params;
        ...
        @java.lang.Override
        public Builder from(CountFeatureUsersResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public CountFeatureUsersResponse build() {
            return new CountFeatureUsersResponse(data, params, additionalProperties);
        }
    }
}
