...
@JsonDeserialize(builder = DeleteCompanyOverrideResponse.Builder.class)
public final class DeleteCompanyOverrideResponse {
    ...
    private DeleteCompanyOverrideResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteCompanyOverrideResponse && equalTo((DeleteCompanyOverrideResponse) other);
    }
    ...
    private boolean equalTo(DeleteCompanyOverrideResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteCompanyOverrideResponse other);
    }

    public interface _FinalStage {
        DeleteCompanyOverrideResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteCompanyOverrideResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public DeleteCompanyOverrideResponse build() {
            return new DeleteCompanyOverrideResponse(data, params, additionalProperties);
        }
    }
}
