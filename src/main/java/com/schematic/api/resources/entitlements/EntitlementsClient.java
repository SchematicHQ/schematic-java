...
public class EntitlementsClient {
    ...
    public ListFeatureUsageHistoryResponse listFeatureUsageHistory(ListFeatureUsageHistoryRequest request) {
        return this.rawClient.listFeatureUsageHistory(request).body();
    }

    public ListFeatureUsageHistoryResponse listFeatureUsageHistory(
            ListFeatureUsageHistoryRequest request, RequestOptions requestOptions) {
        return this.rawClient.listFeatureUsageHistory(request, requestOptions).body();
    }
