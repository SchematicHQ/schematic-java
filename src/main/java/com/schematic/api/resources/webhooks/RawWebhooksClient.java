...
public class RawWebhooksClient {
    ...
    public BaseSchematicHttpResponse<ListWebhookEventsResponse> listWebhookEvents() {
    ...
    public BaseSchematicHttpResponse<GetWebhookEventResponse> getWebhookEvent(String webhookEventId) {
    ...
    public BaseSchematicHttpResponse<CreateWebhookResponse> createWebhook(CreateWebhookRequestBody request) {
    ...
    public BaseSchematicHttpResponse<GetWebhookResponse> getWebhook(String webhookId) {
    ...
    public BaseSchematicHttpResponse<UpdateWebhookResponse> updateWebhook(String webhookId) {
    ...
    public BaseSchematicHttpResponse<DeleteWebhookResponse> deleteWebhook(String webhookId) {
    ...
    public BaseSchematicHttpResponse<SendTestWebhookActionResponse> sendTestWebhookAction(
    ...
    public BaseSchematicHttpResponse<SendTestWebhookActionResponse> sendTestWebhookAction(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SendTestWebhookActionResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
