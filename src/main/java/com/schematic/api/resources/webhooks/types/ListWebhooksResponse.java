...
public final class ListWebhooksResponse {
    private final List<WebhookResponseData> data;

    private final ListWebhooksParams params;

    private final Map<String, Object> additionalProperties;

    private ListWebhooksResponse(
            List<WebhookResponseData> data, ListWebhooksParams params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
     ...
     */
    @JsonProperty("params")
    public ListWebhooksParams getParams() {
        return params;
    }
    ...
    public interface ParamsStage {
        _FinalStage params(ListWebhooksParams params);
    ...
    public interface _FinalStage {
        ...
        _FinalStage addAllData(List<WebhookResponseData> data);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements ParamsStage, _FinalStage {
        private ListWebhooksParams params;

        private List<WebhookResponseData> data = new ArrayList<>();
        ...
        @java.lang.Override
        @JsonSetter("params")
        public _FinalStage params(ListWebhooksParams params) {
            this.params = params;
            return this;
        }
