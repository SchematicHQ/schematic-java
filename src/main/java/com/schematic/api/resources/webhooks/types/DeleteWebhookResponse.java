...
@JsonDeserialize(builder = DeleteWebhookResponse.Builder.class)
public final class DeleteWebhookResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteWebhookResponse && equalTo((DeleteWebhookResponse) other);
    }
    ...
    private boolean equalTo(DeleteWebhookResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteWebhookResponse other);
    }

    public interface _FinalStage {
        DeleteWebhookResponse build();
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteWebhookResponse other) {
            data(other.getData());
        ...
        public DeleteWebhookResponse build() {
            return new DeleteWebhookResponse(data, params, additionalProperties);
        }
    }
}
