...
import com.schematic.api.types.WebhookResponseData;
...
@JsonDeserialize(builder = UpdateWebhookResponse.Builder.class)
public final class UpdateWebhookResponse {
    private final WebhookResponseData data;
    ...
    private UpdateWebhookResponse(
            WebhookResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateWebhookResponse && equalTo((UpdateWebhookResponse) other);
    }
    ...
    private boolean equalTo(UpdateWebhookResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(UpdateWebhookResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateWebhookResponse other) {
            data(other.getData());
        ...
        public UpdateWebhookResponse build() {
            return new UpdateWebhookResponse(data, params, additionalProperties);
        }
    }
}
