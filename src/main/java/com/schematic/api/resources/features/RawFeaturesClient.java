...
public class RawFeaturesClient {
    ...
    public BaseSchematicHttpResponse<CountAudienceCompaniesResponse> countAudienceCompanies(
    ...
    public BaseSchematicHttpResponse<CountAudienceUsersResponse> countAudienceUsers(AudienceRequestBody request) {
        return countAudienceUsers(request, null);
    }

    public BaseSchematicHttpResponse<CountAudienceUsersResponse> countAudienceUsers(
            AudienceRequestBody request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CountAudienceUsersResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
    ...
    public BaseSchematicHttpResponse<ListAudienceCompaniesResponse> listAudienceCompanies(AudienceRequestBody request) {
        return listAudienceCompanies(request, null);
    }

    public BaseSchematicHttpResponse<ListAudienceCompaniesResponse> listAudienceCompanies(
            AudienceRequestBody request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ListAudienceCompaniesResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
    ...
    public BaseSchematicHttpResponse<ListAudienceUsersResponse> listAudienceUsers(AudienceRequestBody request) {
        return listAudienceUsers(request, null);
    }

    public BaseSchematicHttpResponse<ListAudienceUsersResponse> listAudienceUsers(
            AudienceRequestBody request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ListAudienceUsersResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
