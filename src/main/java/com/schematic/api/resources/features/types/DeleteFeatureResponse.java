...
@JsonDeserialize(builder = DeleteFeatureResponse.Builder.class)
public final class DeleteFeatureResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteFeatureResponse && equalTo((DeleteFeatureResponse) other);
    }
    ...
    private boolean equalTo(DeleteFeatureResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteFeatureResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteFeatureResponse other) {
            data(other.getData());
        ...
        public DeleteFeatureResponse build() {
            return new DeleteFeatureResponse(data, params, additionalProperties);
        }
    }
}
