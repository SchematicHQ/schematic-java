...
public final class ListFeaturesResponse {
    private final List<FeatureDetailResponseData> data;

    private final ListFeaturesParams params;

    private final Map<String, Object> additionalProperties;

    private ListFeaturesResponse(
            List<FeatureDetailResponseData> data, ListFeaturesParams params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
     ...
     */
    @JsonProperty("params")
    public ListFeaturesParams getParams() {
        return params;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListFeaturesResponse && equalTo((ListFeaturesResponse) other);
    }
    ...
    private boolean equalTo(ListFeaturesResponse other) {
    ...
    public interface _FinalStage {
        ...
        _FinalStage addAllData(List<FeatureDetailResponseData> data);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements ParamsStage, _FinalStage {
        private ListFeaturesParams params;

        private List<FeatureDetailResponseData> data = new ArrayList<>();
        ...
        @java.lang.Override
        public Builder from(ListFeaturesResponse other) {
            data(other.getData());
