...
public final class ListAudienceUsersResponse {
    ...
    private ListAudienceUsersResponse(
            List<UserDetailResponseData> data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListAudienceUsersResponse && equalTo((ListAudienceUsersResponse) other);
    }
    ...
    private boolean equalTo(ListAudienceUsersResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListAudienceUsersResponse other) {
            data(other.getData());
        ...
        public Builder data(List<UserDetailResponseData> data) {
            this.data.clear();
            this.data.addAll(data);
            return this;
        }

        public Builder addData(UserDetailResponseData data) {
            this.data.add(data);
            return this;
        }

        public Builder addAllData(List<UserDetailResponseData> data) {
            this.data.addAll(data);
            return this;
        }
        ...
        public ListAudienceUsersResponse build() {
            return new ListAudienceUsersResponse(data, params, additionalProperties);
        }
    }
}
