...
import com.schematic.api.types.ManagePlanResponseResponseData;
...
@JsonDeserialize(builder = ManagePlanResponse.Builder.class)
public final class ManagePlanResponse {
    private final ManagePlanResponseResponseData data;

    private final Map<String, JsonNode> params;

    private final Map<String, Object> additionalProperties;

    private ManagePlanResponse(
            ManagePlanResponseResponseData data,
    ...
    @JsonProperty("data")
    public ManagePlanResponseResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ManagePlanResponse && equalTo((ManagePlanResponse) other);
    }
    ...
    private boolean equalTo(ManagePlanResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull ManagePlanResponseResponseData data);

        Builder from(ManagePlanResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private ManagePlanResponseResponseData data;
        ...
        @java.lang.Override
        public Builder from(ManagePlanResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull ManagePlanResponseResponseData data) {
