...
@JsonDeserialize(builder = UpdateCustomerSubscriptionTrialEndResponse.Builder.class)
public final class UpdateCustomerSubscriptionTrialEndResponse {
    ...
    private UpdateCustomerSubscriptionTrialEndResponse(
            BillingSubscriptionView data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    @JsonProperty("data")
    public BillingSubscriptionView getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateCustomerSubscriptionTrialEndResponse
                && equalTo((UpdateCustomerSubscriptionTrialEndResponse) other);
    }
    ...
    private boolean equalTo(UpdateCustomerSubscriptionTrialEndResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(BillingSubscriptionView data);

        Builder from(UpdateCustomerSubscriptionTrialEndResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private BillingSubscriptionView data;
        ...
        @java.lang.Override
        public Builder from(UpdateCustomerSubscriptionTrialEndResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(BillingSubscriptionView data) {
            this.data = data;
            return this;
        }
