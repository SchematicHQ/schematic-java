...
public final class CheckoutInternalResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CheckoutInternalResponse && equalTo((CheckoutInternalResponse) other);
    }
    ...
    private boolean equalTo(CheckoutInternalResponse other) {
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CheckoutInternalResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        public CheckoutInternalResponse build() {
            return new CheckoutInternalResponse(data, params, additionalProperties);
        }
    }
}
