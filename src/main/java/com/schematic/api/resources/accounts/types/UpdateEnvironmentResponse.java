...
@JsonDeserialize(builder = UpdateEnvironmentResponse.Builder.class)
public final class UpdateEnvironmentResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateEnvironmentResponse && equalTo((UpdateEnvironmentResponse) other);
    }
    ...
    private boolean equalTo(UpdateEnvironmentResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(EnvironmentResponseData data);

        Builder from(UpdateEnvironmentResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateEnvironmentResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(EnvironmentResponseData data) {
            this.data = data;
            return this;
        }
        ...
        public UpdateEnvironmentResponse build() {
            return new UpdateEnvironmentResponse(data, params, additionalProperties);
        }
    }
}
