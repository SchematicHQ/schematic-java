...
import com.schematic.api.types.EnvironmentDetailResponseData;
...
@JsonDeserialize(builder = CreateEnvironmentResponse.Builder.class)
public final class CreateEnvironmentResponse {
    private final EnvironmentDetailResponseData data;
    ...
    private CreateEnvironmentResponse(
            EnvironmentDetailResponseData data,
    ...
    @JsonProperty("data")
    public EnvironmentDetailResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateEnvironmentResponse && equalTo((CreateEnvironmentResponse) other);
    }
    ...
    private boolean equalTo(CreateEnvironmentResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull EnvironmentDetailResponseData data);

        Builder from(CreateEnvironmentResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private EnvironmentDetailResponseData data;
        ...
        @java.lang.Override
        public Builder from(CreateEnvironmentResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull EnvironmentDetailResponseData data) {
        ...
        public CreateEnvironmentResponse build() {
            return new CreateEnvironmentResponse(data, params, additionalProperties);
        }
    }
}
