...
@JsonDeserialize(builder = GetApiKeyResponse.Builder.class)
public final class GetApiKeyResponse {
    private final ApiKeyResponseData data;
    ...
    private GetApiKeyResponse(
            ApiKeyResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetApiKeyResponse && equalTo((GetApiKeyResponse) other);
    }
    ...
    private boolean equalTo(GetApiKeyResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(GetApiKeyResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetApiKeyResponse other) {
            data(other.getData());
        ...
        public GetApiKeyResponse build() {
            return new GetApiKeyResponse(data, params, additionalProperties);
        }
    }
}
