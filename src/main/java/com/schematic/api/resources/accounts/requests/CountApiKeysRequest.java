...
public final class CountApiKeysRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CountApiKeysRequest && equalTo((CountApiKeysRequest) other);
    }
    ...
    private boolean equalTo(CountApiKeysRequest other) {
    ...
    public interface RequireEnvironmentStage {
        ...
        Builder from(CountApiKeysRequest other);
    }
    ...
    public static final class Builder implements RequireEnvironmentStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CountApiKeysRequest other) {
