...
public class RawAccountsClient {
    ...
    public BaseSchematicHttpResponse<ListAccountMembersResponse> listAccountMembers() {
        return listAccountMembers(ListAccountMembersRequest.builder().build());
    }

    public BaseSchematicHttpResponse<ListAccountMembersResponse> listAccountMembers(RequestOptions requestOptions) {
        return listAccountMembers(ListAccountMembersRequest.builder().build(), requestOptions);
    }

    public BaseSchematicHttpResponse<ListAccountMembersResponse> listAccountMembers(ListAccountMembersRequest request) {
    ...
    public BaseSchematicHttpResponse<GetAccountMemberResponse> getAccountMember(String accountMemberId) {
        return getAccountMember(accountMemberId, null);
    }

    public BaseSchematicHttpResponse<GetAccountMemberResponse> getAccountMember(
    ...
    public BaseSchematicHttpResponse<CountAccountMembersResponse> countAccountMembers() {
        return countAccountMembers(CountAccountMembersRequest.builder().build());
    }

    public BaseSchematicHttpResponse<CountAccountMembersResponse> countAccountMembers(RequestOptions requestOptions) {
    ...
    public BaseSchematicHttpResponse<CountAccountMembersResponse> countAccountMembers(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new BaseSchematicHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CountAccountMembersResponse.class),
                        response);
            }
            try {
                switch (response.code()) {
    ...
    public BaseSchematicHttpResponse<GetOnboardingStateResponse> getOnboardingState() {
        return getOnboardingState(null);
    }

    public BaseSchematicHttpResponse<GetOnboardingStateResponse> getOnboardingState(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public BaseSchematicHttpResponse<UpdateOnboardingStateResponse> updateOnboardingState() {
