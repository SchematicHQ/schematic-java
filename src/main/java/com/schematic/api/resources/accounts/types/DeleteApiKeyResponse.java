...
@JsonDeserialize(builder = DeleteApiKeyResponse.Builder.class)
public final class DeleteApiKeyResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteApiKeyResponse && equalTo((DeleteApiKeyResponse) other);
    }
    ...
    private boolean equalTo(DeleteApiKeyResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteApiKeyResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteApiKeyResponse other) {
            data(other.getData());
        ...
        public DeleteApiKeyResponse build() {
            return new DeleteApiKeyResponse(data, params, additionalProperties);
        }
    }
}
