...
import com.schematic.api.types.ApiKeyCreateResponseData;
...
@JsonDeserialize(builder = CreateApiKeyResponse.Builder.class)
public final class CreateApiKeyResponse {
    private final ApiKeyCreateResponseData data;
    ...
    private CreateApiKeyResponse(
            ApiKeyCreateResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    @JsonProperty("data")
    public ApiKeyCreateResponseData getData() {
        return data;
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull ApiKeyCreateResponseData data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private ApiKeyCreateResponseData data;
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull ApiKeyCreateResponseData data) {
        ...
        public CreateApiKeyResponse build() {
            return new CreateApiKeyResponse(data, params, additionalProperties);
        }
    }
}
