...
@JsonDeserialize(builder = DeleteEnvironmentResponse.Builder.class)
public final class DeleteEnvironmentResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteEnvironmentResponse && equalTo((DeleteEnvironmentResponse) other);
    }
    ...
    private boolean equalTo(DeleteEnvironmentResponse other) {
    ...
    public interface DataStage {
        ...
        Builder from(DeleteEnvironmentResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeleteEnvironmentResponse other) {
            data(other.getData());
        ...
        public DeleteEnvironmentResponse build() {
            return new DeleteEnvironmentResponse(data, params, additionalProperties);
        }
    }
}
