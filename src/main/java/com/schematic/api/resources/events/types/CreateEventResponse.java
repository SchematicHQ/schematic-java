...
import com.schematic.api.types.RawEventResponseData;
...
@JsonDeserialize(builder = CreateEventResponse.Builder.class)
public final class CreateEventResponse {
    private final RawEventResponseData data;
    ...
    private CreateEventResponse(
            RawEventResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    @JsonProperty("data")
    public RawEventResponseData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateEventResponse && equalTo((CreateEventResponse) other);
    }
    ...
    private boolean equalTo(CreateEventResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull RawEventResponseData data);

        Builder from(CreateEventResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private RawEventResponseData data;
        ...
        @java.lang.Override
        public Builder from(CreateEventResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull RawEventResponseData data) {
