...
@JsonDeserialize(builder = GetEventResponse.Builder.class)
public final class GetEventResponse {
    private final EventDetailResponseData data;
    ...
    private GetEventResponse(
            EventDetailResponseData data, Map<String, JsonNode> params, Map<String, Object> additionalProperties) {
        this.data = data;
        this.params = params;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetEventResponse && equalTo((GetEventResponse) other);
    }
    ...
    private boolean equalTo(GetEventResponse other) {
    ...
    public interface DataStage {
        _FinalStage data(@NotNull EventDetailResponseData data);

        Builder from(GetEventResponse other);
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        private EventDetailResponseData data;
        ...
        @java.lang.Override
        public Builder from(GetEventResponse other) {
            data(other.getData());
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull EventDetailResponseData data) {
        ...
        public GetEventResponse build() {
            return new GetEventResponse(data, params, additionalProperties);
        }
    }
}
