...
@JsonDeserialize(builder = FeatureView.Builder.class)
public final class FeatureView {
    ...
    private final List<FlagView> flags;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FeatureView && equalTo((FeatureView) other);
    }
    ...
    public interface AccountIdStage {
        ...
        Builder from(FeatureView other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage flags(List<FlagView> flags);
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public _FinalStage addFlags(FlagView flags) {
        ...
        public _FinalStage flags(List<FlagView> flags) {
            this.flags.clear();
            if (flags != null) {
                this.flags.addAll(flags);
            }
