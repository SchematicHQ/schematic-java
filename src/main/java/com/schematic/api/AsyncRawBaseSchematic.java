...
public class AsyncRawBaseSchematic {
    ...
    public CompletableFuture<BaseSchematicHttpResponse<Void>> getCreditLedger() {
        return getCreditLedger(null);
    }

    public CompletableFuture<BaseSchematicHttpResponse<Void>> getCreditLedger(RequestOptions requestOptions) {
